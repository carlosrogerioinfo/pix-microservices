...
namespace Pix.Gateway.Api.Controllers
{
    ...
    public class BankController: BaseController
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] PaginationFilter paginationFilter, [FromQuery] BankFilter filter)
        {
            var data = await _service.GetAll(Request.Headers["Authorization"], paginationFilter, filter);
