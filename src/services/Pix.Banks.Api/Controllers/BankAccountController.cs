...
namespace Pix.Banks.Api.Controllers
{
    ...
    public class BankAccountController : BaseController
    {
        ...
        /// <summary>
        /// Retorna a lista dos registros da tabela conta bancária pelos filtros dinamicos
        /// </summary>
        ...
        public async Task<IActionResult> GetAllByFilter([FromQuery] PaginationFilter paginationFilter, [FromQuery] BankAccountFilter filter)
        {
        ...
        /// <summary>
        /// Retorna o registro da tabela conta bancária filtrado pelo id
        /// </summary>
        ...
        /// <summary>
        /// Insere um registro na tabela conta bancária
        /// </summary>
